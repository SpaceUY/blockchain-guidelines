...
This documentation is first divided in different technologies or areas of knowledge (EVM, Solana, etc.), and inside of each section, you'll find:

• A **basic knowledge guide** with introductory concepts to the specific technology - basically a tech starter pack! This **does not assume prior knowledge**.

• A set of **fundamental theoretical pieces of knowledge**, that will further your journey in each technology.

• A **developer guide**, which will guide you through common problems and solutions we have explored in SpaceDev.
